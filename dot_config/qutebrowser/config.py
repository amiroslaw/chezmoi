...
config.bind('ee', 'spawn -u engine.clj --change')
...
config.bind('ahd', urlCmdHint+ 'url.lua --dlAudio "{hint-url}"')
config.bind('aad', urlCmdRapid + 'url.lua --dlAudio "{hint-url}"')
config.bind('ald', 'spawn url.lua --dlAudio "{url}"')
config.bind('ahy', urlCmdHint+ 'url.lua --dlVideo "{hint-url}"')
config.bind('aay', urlCmdRapid + 'url.lua --dlVideo "{hint-url}"')
config.bind('aly', 'spawn url.lua --dlVideo "{url}"')
...
config.bind('aak', urlCmdRapid + 'url.lua --kindle --email "{hint-url}"')
...
config.bind('aav', urlCmdRapid + 'url.lua --mpvVideo "{hint-url}"')
config.bind('ahf', urlCmdHint + 'url.lua --mpvFullscreen {hint-url}')
config.bind('alf', 'spawn url.lua --mpvFullscreen "{url}"')
config.bind('aaf', urlCmdRapid + 'url.lua --mpvFullscreen "{hint-url}"')
config.bind('ahp', urlCmdHint + 'url.lua --mpvPopup {hint-url}')
config.bind('alp', 'spawn url.lua --mpvPopup {url}')
config.bind('aap', urlCmdRapid + 'url.lua --mpvPopup "{hint-url}"')
config.bind('aha', urlCmdHint + 'url.lua --mpvAudio {hint-url}')
config.bind('ala', 'spawn url.lua --mpvAudio "{url}"')
config.bind('aaa', urlCmdRapid + 'url.lua --mpvAudio "{hint-url}"')
...
config.bind('<Ctrl-Shift-s>', 'spawn -u engine.clj -s', 'insert')
# }}}
# }}}
